...
public interface ExternalTransactionRepository extends CrudRepository<ExternalTransaction, Integer> {
     ...
     */
    List<ExternalTransaction> findByCreditAccount(@Param("pmbAccount") PMBAccount pmbAccount);
     ...
     */
    List<ExternalTransaction> findByDebitAccount(@Param("pmbAccount") PMBAccount pmbAccount);
}
